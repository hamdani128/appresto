    ...
    <nav class="navbar navbar-expand-xl w-100">
        <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
            ...
            <li class="nav-item dropdown">
                <a href="javascript:;"
                    class="nav-link dropdown-toggle dropdown-toggle-nocaret                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <?php echo uri_string() == 'master/makanan' || uri_string() == 'master/minuman' || uri_string() == 'master/meja' ? 'active text-white' : '' ?>"
