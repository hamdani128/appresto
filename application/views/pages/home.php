                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13 text-white"><i class="bx bxs-up-arrow align-middle"></i>1.6K from
                                    last week</p>
                            </div>
                            <div class="widgets-icons bg-light-transparent text-white ms-auto"><i
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13 text-white"><i class="bx bxs-down-arrow align-middle"></i>2.4K
                                    from last week</p>
                            </div>
                            <div class="widgets-icons bg-light-transparent text-white ms-auto"><i
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <p class="mb-0 font-13 text-white"><i class="bx bxs-down-arrow align-middle"></i>12.2%
                                    from last week</p>
                            </div>
                ...
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        ...
                        <div
                            ...
                            <div class="">
                                <h5 class="mb-0">974 <span class="text-success font-13">56% <i
                                            class='bx bx-up-arrow-alt'></i></span></h5>
                                <p class="mb-0">Page Views</p>
                            </div>
                            <div class="vr"></div>
                            <div class="">
                                <h5 class="mb-0">1,218 <span class="text-danger font-13">34% <i
                                            class='bx bx-down-arrow-alt'></i></span></h5>
                                <p class="mb-0">Total Sales</p>
                            </div>
                            <div class="vr"></div>
                            <div class="">
                                <h5 class="mb-0">42.8% <span class="text-success font-13">22% <i
                                            class='bx bx-up-arrow-alt'></i></span></h5>
