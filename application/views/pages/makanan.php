<div ng-app="CombineMakanan">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <h6 class="mb-0 text-uppercase">Informasi Data Makanan</h6>
            <hr />
            <div class="card" ng-module="appmakanan" ng-controller="ControllerMakanan">
                <div class="card-body">
                    <div class="row pb-5">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <hr>
                    <div class="tab-content" id="pills-tabContent" ng-module="makanan"
                        ng-controller="ControllerCategoryMakanan">
